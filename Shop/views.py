...
# Home part
def Home(request):
    random_items = list(Product1.objects.order_by('?')[:9])
...
def search(request):
    if request.method == 'GET':
        ...
        # Extract the searchmy_objects from the product data
        search_results = []
        product_ids = set()
        ...
        # Render the searchmy_objects template with the searchmy_objects
